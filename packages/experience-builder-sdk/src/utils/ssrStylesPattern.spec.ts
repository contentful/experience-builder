...
describe('pattern component', () => {
  it('should extract media query css', () => {
    ...
    expect(styles).toBe(
      '.cf-6b8d7c13816018b32e939235165d04ad{margin:0 Auto 0 Auto;padding:10px 10px 10px 10px;background-color:rgba(255, 255, 255, 0);width:100%;max-width:1192px;border:0px outside rgba(255, 255, 255, 0);gap:10px 10px;font-family:Arial;font-style:normal;text-decoration:none;box-sizing:border-box;}.cf-3da1e77e5df23772f0720d5aa6493b8e{padding:0 0 0 0;background-color:rgba(255, 255, 255, 0);grid-column:span 6;border:0px outside rgba(255, 255, 255, 0);gap:0px 0px;align-items:start;justify-content:safe center;flex-direction:column;flex-wrap:nowrap;font-family:Arial;font-style:normal;text-decoration:none;box-sizing:border-box;}.cf-79e5a68363b48b7bf122e4c7315f024a{padding:0 0 0 0;background-color:rgba(255, 255, 255, 0);grid-column:span 6;border:0px outside rgba(255, 255, 255, 0);gap:0px 0px;align-items:center;justify-content:safe center;flex-direction:column;flex-wrap:nowrap;font-family:Arial;font-style:normal;text-decoration:none;box-sizing:border-box;}@media(max-width:992px){.cf-ef482b7371f2497a86df1fe909795008{font-family:Arial;font-style:normal;text-decoration:none;box-sizing:border-box;}}@media(max-width:576px){.cf-ef482b7371f2497a86df1fe909795008{font-family:Arial;font-style:normal;text-decoration:none;box-sizing:border-box;}}',
    );
  });
  ...
  it('should resolve binding to an asset and get background-image in extracted css', () => {
    ...
    expect(styles).toBe(
      '.cf-525246ea26d5750833b4501b6ffdfd3c{margin:0 Auto 0 Auto;padding:10px 10px 10px 10px;background-color:rgba(255, 255, 255, 0);width:100%;max-width:1192px;border:0px outside rgba(255, 255, 255, 0);gap:10px 10px;background-image:url(https://www.contentful.com/image-asset.jpg);background-repeat:no-repeat;font-family:Arial;font-style:normal;text-decoration:none;box-sizing:border-box;}.cf-3da1e77e5df23772f0720d5aa6493b8e{padding:0 0 0 0;background-color:rgba(255, 255, 255, 0);grid-column:span 6;border:0px outside rgba(255, 255, 255, 0);gap:0px 0px;align-items:start;justify-content:safe center;flex-direction:column;flex-wrap:nowrap;font-family:Arial;font-style:normal;text-decoration:none;box-sizing:border-box;}.cf-79e5a68363b48b7bf122e4c7315f024a{padding:0 0 0 0;background-color:rgba(255, 255, 255, 0);grid-column:span 6;border:0px outside rgba(255, 255, 255, 0);gap:0px 0px;align-items:center;justify-content:safe center;flex-direction:column;flex-wrap:nowrap;font-family:Arial;font-style:normal;text-decoration:none;box-sizing:border-box;}@media(max-width:992px){.cf-ef482b7371f2497a86df1fe909795008{font-family:Arial;font-style:normal;text-decoration:none;box-sizing:border-box;}}@media(max-width:576px){.cf-ef482b7371f2497a86df1fe909795008{font-family:Arial;font-style:normal;text-decoration:none;box-sizing:border-box;}}',
    );
