      ...
      children: [
        {
          ...
          variables: {
            ...
            cfBorder: {
              type: 'DesignValue',
              valuesByBreakpoint: { desktop: '${border.medium}', tablet: '${border.small}' },
            },
            cfGap: {
              type: 'DesignValue',
            ...
            cfBackgroundImageUrl: { type: 'UnboundValue', key: 'iNB7E-aJxWgp7aVkvQ3ko' },
            cfBackgroundImageOptions: {
              type: 'DesignValue',
              valuesByBreakpoint: {
...
describe('custom component with builtInStyles', () => {
  ...
  it('should extract builtInStyles as media query css', () => {
    ...
    expect(
      ...
      'cf-2c7bd659441138513548e1973a86532d cf-10a81c89bfdea98dd7aa30311c4620da cf-d2d0bfefe7032e1bd983bdc3c4c8b762',
    );
    expect(
    ...
    const customComponent = section.children[0];
    ...
    expect(styles).toBe(
      '.cf-2c7bd659441138513548e1973a86532d{margin:0 0 0 0;padding:0 0 0 0;background-color:rgba(255, 255, 255, 0);width:calc(100% - 0 - 0);height:fit-content;max-width:none;border:0px solid rgba(0, 0, 0, 0);border-radius:0px;gap:0px 0px;align-items:center;justify-content:safe center;flex-direction:column;flex-wrap:nowrap;font-style:normal;text-decoration:none;box-sizing:border-box;}.cf-2109ec1a9fccae15d7529f415b77a465{margin:0 0 0 0;padding:0 0 0 0;background-color:black;width:100%;height:100%;max-width:none;grid-column:span 1;border:1px solid red;border-radius:0px;gap:10px 10px;align-items:center;justify-content:safe center;flex-direction:row;flex-wrap:wrap;background-image:url(https://www.contentful.com/bg-image.jpg);background-repeat:no-repeat;font-size:16px;font-weight:bold;font-style:italic;line-height:1.5;letter-spacing:1px;color:white;text-align:center;text-transform:uppercase;text-decoration:underline;box-sizing:border-box;}@media(max-width:992px){.cf-10a81c89bfdea98dd7aa30311c4620da{margin:0 0 0 0;padding:0 0 0 0;border:0px solid rgba(0, 0, 0, 0);gap:0px 0px;font-style:normal;text-decoration:none;box-sizing:border-box;}.cf-aed6b8fd8999db736ecad69198982c97{margin:1rem 1rem 1rem 1rem;padding:1rem 1rem 1rem 1rem;background-color:grey;width:50%;height:50%;max-width:500px;grid-column:span 2;border:1px solid green;border-radius:2px;gap:5px 5px;align-items:top;justify-content:left;flex-direction:column;flex-wrap:nowrap;font-size:14px;font-weight:bold;font-style:italic;line-height:1.25;letter-spacing:0.5px;color:black;text-align:left;text-transform:capitalize;text-decoration:underline;box-sizing:border-box;}}@media(max-width:576px){.cf-d2d0bfefe7032e1bd983bdc3c4c8b762{font-style:normal;text-decoration:none;box-sizing:border-box;}.cf-9d7a53e110e877eeaef28ce871edf181{margin:1.5rem 1.5rem 1.5rem 1.5rem;padding:1.5rem 1.5rem 1.5rem 1.5rem;background-color:ashgrey;width:25%;height:25%;max-width:300px;grid-column:span 3;border:1px solid blue;border-radius:5px;gap:2px 2px;align-items:right;justify-content:bottom;flex-direction:row;flex-wrap:wrap;font-size:12px;font-weight:bold;font-style:italic;line-height:1;letter-spacing:0px;color:grey;text-align:right;text-transform:lowercase;text-decoration:underline;box-sizing:border-box;}}',
    );
  });
});
