...
describe('custom component with builtInStyles', () => {
  it('should extract builtInStyles as media query css', () => {
    ...
    expect(
      ...
      `"cf-1fa5a8bdcdab5c92e8a734cb5a89a370 cf-38a5725c769ac23a1a4ea942fe91684e cf-b5e0f019935b207d6667881f98a89ceb"`,
    );
    expect(
