...
describe('custom component with builtInStyles', () => {
  it('should extract builtInStyles as media query css', () => {
    ...
    expect(
      ...
      `"cf-85e2108137367528fc3d0d3ef655dbca cf-c815ccc08aa3c7752c10ed7e761fac90 cf-82ada9343f1f33ae524b346b4a08b097"`,
    );
    expect(
