...
describe('custom component with builtInStyles', () => {
  it('should extract builtInStyles as media query css', () => {
    ...
    expect(
      ...
      `"cf-1fa5a8bdcdab5c92e8a734cb5a89a370 cf-953598ef9f05184b72cda98e5ecd9343 cf-8fd6488eb7cf911feb014f3b876b8a1d"`,
    );
    expect(
