...
1. **Update experiences-slug-example.js**

Go to `experiences-slug-example.js` and fill out the following three consts
...
Go to `useContentfulClient.js` and fill out the following fields
