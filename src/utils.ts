import { LocalizedDataSource, CompositionTree, CompositionComponentNode, StyleProps, LocalizedUnboundValues } from './types'

export const getDataFromTree = (tree: CompositionTree): {
